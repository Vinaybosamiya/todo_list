    ...
    return (
        <nav className='flex justify-between bg-purple1-b text-white-t '>
            ...
            <ul className="flex items-center gap-8 mx-7 p-4 cursor-pointer">
                <li><span className='rounded-2xl px-2 py-1  font-bold  text-[15px] hover:text-black-t hover:bg-white-b  '>Home</span></li>
                <li><span className='rounded-2xl px-2 py-1  font-bold  text-[15px] hover:text-black-t hover:bg-white-b  '>About</span></li>
