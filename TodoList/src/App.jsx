...
localStorage.setItem("Todos", ...) → saves that string in browser storage under the name "Todos".
  ...
  className={`rounded-md mx-2 px-3 cursor-pointer text-white-t hover:bg-purple-b 
    ${Todo.length === 0 ? 'bg-light-purple-b md:bg-light-purple-b' : 'bg-purple-b md:bg-purple-b'}`}
>
  Save
</button>
